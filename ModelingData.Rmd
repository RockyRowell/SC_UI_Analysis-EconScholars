...
```{r}
# model
final.model <- lm(InitialClaims.Lag.PerCapita ~ Unemployment.PerCapita + LaborForce.PerCapita + Layoffs, data = data.2001)
...
check general trends on sc claims
maybe try to forecast ahead
outlier study
check predictions for sp500 predictors on response variable
